				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Tables</span> - Kamar</h4>
						</div>
					</div>
				...
				<!-- HTML sourced data -->
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Data Kamar</h5>
							<div class="heading-elements">
								<ul class="icons-list">
								<button type="button" class="btn btn-success" onclick="location.href='<?php echo site_url('kamar_controller/add')?>'">New Kamar</button>
						...
						<table class="table datatable-html">
							...
							<tbody>
								...
								<tr>
									<td>
										<?php echo $kamar->KM_ID ?>
									</td>
									<td>
										<?php echo $kamar->KM_NO ?>
									</td>
									<td>
										<?php echo $kamar->KM_LOKASI ?>
									</td>
									<td>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											...
											<li><a href="<?php echo site_url('kamar_controller/edit/'.$kamar->KM_ID) ?>"></i>Edit entry</a></li>
											<li><a href="<?php echo site_url('kamar_controller/delete/'.$kamar->KM_ID) ?>"><i class="icon-bin"></i>Remove entry</a></li>
										</ul>
									</li>
								</ul>
									</td>
