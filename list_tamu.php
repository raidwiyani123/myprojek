				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Tables</span> - Tamu</h4>
						</div>
					</div>
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							...
							<div class="heading-elements">
								<ul class="icons-list">
								<button type="button" class="btn btn-success" onclick="location.href='<?php echo site_url('tamu_controller/add')?>'">New Tamu</button>
						...
						<table class="table datatable-html">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php echo $tamu->TM_NAMA ?>
									</td>
									<td>
										<?php echo $tamu->TM_ALAMAT ?>
									</td>
									<td>
										<?php echo $tamu->TM_JK ?>
									</td>
									<td>
										<?php echo $tamu->TM_NOTLP ?>
									</td>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											...
											<li><a href="<?php echo site_url('tamu_controller/edit/'.$tamu->TM_ID) ?>"></i>Edit entry</a></li>
											<li><a href="<?php echo site_url('tamu_controller/delete/'.$tamu->TM_ID) ?>"><i class="icon-bin"></i>Remove entry</a></li>
										</ul>
									</li>
								</ul>
									</td>
