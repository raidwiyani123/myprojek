				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Forms</span> - Input Data</h4>
						</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Input Data Reservasi</h5>
							<div class="heading-elements">
								<ul class="icons-list">
							...
							<form class="form-horizontal" method="POST" action="add">
								<fieldset class="content-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2">Id Reservasir*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('RSV_ID') ? 'is-invalid':'' ?>" type="text" name="RSV_ID" placeholder="" />
										</div>
									...
									<div class="form-group">
										<label class="control-label col-lg-2">Id Tamu*</label>
										<div class="col-lg-10">
										<input class="form-control <?php echo form_error('TM_ID') ? 'is-invalid':'' ?>" type="text" name="TM_ID" placeholder="" />
										</div>
										<div class="invalid-feedback">
									...
									<div class="form-group">
									<label class="control-label col-lg-2">Id Kamar*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('KM_ID') ? 'is-invalid':'' ?>" type="text" name="KM_ID" placeholder="" /></div>
										<div class="invalid-feedback">
									...
									<label class="control-label col-lg-2">Checkin*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('TGL_CHECKIN') ? 'is-invalid':'' ?>" type="text" name="TGL_CHECKIN" placeholder="" /></div>
										<div class="invalid-feedback">
									...
									<label class="control-label col-lg-2">Checkout*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('TGL_CHECKOUT') ? 'is-invalid':'' ?>" type="text" name="TGL_CHECKOUT" placeholder="" /></div>
										<div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
									<label class="control-label col-lg-2">Tgl Pesan*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('TGL_PESAN') ? 'is-invalid':'' ?>" type="text" name="TGL_PESAN" placeholder="" /></div>
										<div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
									<label class="control-label col-lg-2">Lama Menginap*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('LAMA_MENGINAP') ? 'is-invalid':'' ?>" type="text" name="LAMA_MENGINAP" placeholder="" /></div>
										<div class="invalid-feedback">
								...
								<div class="text-right">
									<button type="submit"  onclick="location.href='<?php echo site_url('reservasi_controller/')?>'">Save<i class="icon-arrow-right14 position-right"></i></button>
								</div>
