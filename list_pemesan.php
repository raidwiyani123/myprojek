				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Tables</span> - Pemesan</h4>
						</div>
					</div>
				...
				<!-- HTML sourced data -->
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Data Pemesan</h5>
							<div class="heading-elements">
								<ul class="icons-list">
								<button type="button" class="btn btn-success" onclick="location.href='<?php echo site_url('pemesan_controller/add')?>'">New Pemesan</button>
						...
						<table class="table datatable-html">
							...
							<tbody>
								<?php foreach ($pemesan as $pemesan): ?>
								<?php $no=1; ?>

								<tr>
									<td>
										<?php echo $pemesan->PMSN_ID ?>
									</td>
									<td>
										<?php echo $pemesan->RSV_ID ?>
									</td>
									<td>
										<?php echo $pemesan->GUESS?>
									</td>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											...
											<li><a href="<?php echo site_url('pemesan_controller/edit/'.$pemesan->PMSN_ID) ?>"></i>Edit entry</a></li>
											<li><a href="<?php echo site_url('pemesan_controller/delete/'.$pemesan->PMSN_ID) ?>"><i class="icon-bin"></i>Remove entry</a></li>
										</ul>
									</li>
								</ul>
									</td>
