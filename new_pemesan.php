				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Input Data Pemesan</h5>
							<div class="heading-elements">
								<ul class="icons-list">
							...
							<form class="form-horizontal" method="POST" action="add">
								<fieldset class="content-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2">Id Pemesan*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('PMSN_ID') ? 'is-invalid':'' ?>" type="text" name="PMSN_ID" placeholder="" />
										</div>
										<div class="invalid-feedback">
											<?php echo form_error('PMSN_ID') ?>
										</div>
									</div>

									<div class="form-group">
										<label class="control-label col-lg-2">Id Reservasi*</label>
										<div class="col-lg-10">
									...
									<div class="form-group">
									<label class="control-label col-lg-2">Guess*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('GUESS') ? 'is-invalid':'' ?>" type="text" name="GUESS" placeholder="" /></div>
										<div class="invalid-feedback">
								...
								<div class="text-right">
									<button type="submit"  onclick="location.href='<?php echo site_url('pemesan_controller/')?>'">Save<i class="icon-arrow-right14 position-right"></i></button>
								</div>
