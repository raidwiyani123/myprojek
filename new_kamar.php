							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active" ><a href="<?= site_url('kamar_controller')?>">Kelola Data Kamar</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Input Data Kamar</h5>
							<div class="heading-elements">
								<ul class="icons-list">
							...
							<form class="form-horizontal" method="POST" action="add">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('KM_ID') ? 'is-invalid':'' ?>" type="text" name="KM_ID" placeholder="" />
										</div>
									...
									<div class="form-group">
										<label class="control-label col-lg-2">No Kamar*</label>
										<div class="col-lg-10">
										<input class="form-control <?php echo form_error('KM_NO') ? 'is-invalid':'' ?>" type="text" name="KM_NO" placeholder="" />
										</div>
										<div class="invalid-feedback">
									...
									<label class="control-label col-lg-2">Lokasi*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('KM_LOKASI') ? 'is-invalid':'' ?>" type="text" name="KM_LOKASI" placeholder="" /></div>
										<div class="invalid-feedback">
									...
									<label class="control-label col-lg-2">Fasilitas*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('FASILITAS') ? 'is-invalid':'' ?>" type="text" name="FASILITAS" placeholder="" /></div>
										<div class="invalid-feedback">
									...
									<label class="control-label col-lg-2">Harga*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('HARGA') ? 'is-invalid':'' ?>" type="text" name="HARGA" placeholder="" /></div>
										<div class="invalid-feedback">
									...
									<label class="control-label col-lg-2">Kapasitas*</label>
										<div class="col-lg-10">
											<input class="form-control <?php echo form_error('KM_KAPASITAS') ? 'is-invalid':'' ?>" type="text" name="KM_KAPASITAS" placeholder="" /></div>
										<div class="invalid-feedback">
								...
								<div class="text-right">
									<button type="submit"  onclick="location.href='<?php echo site_url('kamar_controller/')?>'">Save<i class="icon-arrow-right14 position-right"></i></button>
								</div>
